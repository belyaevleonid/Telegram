...
//        proxySection2Row = rowCount++;
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ModSettings", R.string.ModSettings));
...
//            }
            if (position == enableStreamRow) {
                SharedConfig.toggleStartFront();
                TextCheckCell textCheckCell = (TextCheckCell) view;
                textCheckCell.setChecked(SharedConfig.startFront);
            }
...
//                }
                case 3: {
                    ...
                    if (position == enableStreamRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("StartRoundFromFront", R.string.StartRoundFromFront), SharedConfig.startFront, enableAllStreamRow != -1);
                    }
//                    else if (position == enableCacheStreamRow) {
//                        checkCell.setTextAndCheck(LocaleController.getString("StartRoundFromFront", R.string.StartRoundFromFront), SharedConfig.saveStreamMedia, true);
//                    } else if (position == enableMkvRow) {
